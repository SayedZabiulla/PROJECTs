...
MODELS_PATH = os.path.join(PROJECT_PATH, "models/densenet121")
RESULTS_PATH = os.path.join(PROJECT_PATH, "results/densenet121")
...
print("="*60)
print("DENSENET121 EVALUATION ON TEST SET")
print("="*60)
...
def plot_confusion_matrix(cm, save_path):
    ...
    plt.title('DenseNet121 - Confusion Matrix (Test Set)', fontsize=14, fontweight='bold')
    plt.tight_layout()
...
def plot_metrics_bar(metrics, save_path):
    ...
    ax.set_title('DenseNet121 - Performance Metrics (Test Set)', fontsize=14, fontweight='bold')
...
def main():
    ...
    model = create_densenet_model(pretrained=False, freeze_backbone=False, device=device)
